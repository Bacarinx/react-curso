...
//   const name = "Joaquim";
  ...
  const pessoas = [
      {nome: "Henrique", idade: 18, profissao: "Desempregado"},
      {nome: "Giovana", idade: 5, profissao: "Desempregado"},
      {nome: "João", idade: 22, profissao: "Entregador"},
      {nome: "Thayna", idade: 17, profissao: "Escritora"}
  ]
